        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              buildBulletPoint(
                'This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name [Enter domain name] (“Website”), including the related mobile site and mobile application (hereinafter referred to as “Platform”).',
              ),
              const SizedBox(height: 10),
              buildBulletPoint(
                'The Platform is owned by Alles Mogelijk Service Private Limited, a company incorporated under the Companies Act, 1956 with its registered office at bari gidarmari,post sukhasan,katihar,bihar.',
              ),
              const SizedBox(height: 10),
              buildBulletPoint(
              ...
              buildBulletPoint(
                'All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in katihar, bihar.',
              ),
              buildBulletPoint(
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          const Text(
            '•',
            style: TextStyle(fontSize: 25, height: .7),
          ),
